...
import 'package:flipnews/presentation/widgets/news_details.dart';
import 'package:flipnews/presentation/widgets/news_feed.dart';
...
class _FlipCardState extends State<FlipCard> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Center(
          child: currentIndex != null ? GestureDetector(
            onTap: () {
