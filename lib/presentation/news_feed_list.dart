...
class _NewsFeedListState extends State<NewsFeedList> {
  ...
  Future<void> fetchHeadLines() async {  
    ...
    final topHeadlinesUrl =
        '${baseUrl}top-headlines?country=us${selectedCategory == Category.all.name ? '' : '&category=$selectedCategory'}&apiKey=${const String.fromEnvironment('auth_key')}';
    ...
    return Padding(
            ...
            child: Column(
              children: [
                ...
                Expanded(
                  child: focusNode.hasFocus ? Container(): Column(
                    children: [
                      Container(
                        height: 55,
